...
This project is indexed by GitNexus as **projektplattform_v3** (11713 symbols, 18193 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
