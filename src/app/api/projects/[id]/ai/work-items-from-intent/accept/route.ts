/**
 * PROJ-153-α — Übernahme der Vorschläge aus dem Vorhaben.
 *
 *   POST /api/projects/[id]/ai/work-items-from-intent/accept
...
export async function POST(request: Request, ctx: Ctx) {
  ...
  const { data, error } = await supabase.rpc("accept_work_items_from_intent_bulk", {
