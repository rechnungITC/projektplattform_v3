...
// PROJ-117 (AC1) — lazy-seed the 6 standard committee templates for the tenant
// (seed_committee_templates RPC; tenant-admin, idempotent).
export async function POST(
  ...
  const { data, error } = await supabase.rpc("seed_committee_templates", {
