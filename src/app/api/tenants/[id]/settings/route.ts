...
const SELECT_COLUMNS =
  "tenant_id, active_modules, privacy_defaults, ai_provider_config, retention_overrides, feature_flags, budget_settings, output_rendering_settings, assistant_settings, cost_settings, risk_score_overrides, created_at, updated_at"
