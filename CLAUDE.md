...
This project is indexed by GitNexus as **projektplattform_v3** (21529 symbols, 32464 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
