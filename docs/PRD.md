...
| PROJ-35 | P1 | Stakeholder-Wechselwirkungs-Engine — tenant-konfigurierbarer Risk-Score (influence × impact × attitude × Big5-modifier), 4 Eskalations-Patterns (MVP-Pflicht), 32-Kombinations-Big5-Tonalitäts-Lookup, Critical-Path-Risk, Health-Dashboard (Page + Tab-Shortcut). Daten-Basis für PROJ-36 KI-Coaching. 3 Phasen (35-α/β/γ), ~8 PT. | Planned |
