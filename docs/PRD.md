...
| PROJ-35 | P1 | Stakeholder-Wechselwirkungs-Engine — deterministischer Risk-Score (influence × impact × attitude × Big5-modifier), Eskalations-Indikatoren, Tonalitäts-Empfehlungen, Critical-Path-Risk, Health-Dashboard. Daten-Basis für PROJ-36 KI-Coaching. | Sketched |
