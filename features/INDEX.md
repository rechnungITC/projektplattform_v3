...
| PROJ-53 | Gantt Timeline-Scale (MS-Project-Style) — α: zweireihiger Header + Wochenenden + ISO-KW + Tages-Grid. β: Sticky-Header (SVG-internes `<g translate(0, scrollTop)>`) + Feiertage (`date-holidays`, `tenants.holiday_region`). γ: Memo-Split + Custom-Kalender + Multi-Locale + PNG/PDF-Export. | Approved (α deployed 2026-05-06; β backend deployed 2026-05-06; β frontend implemented + QA-approved 2026-05-11; γ items deferred) | [Spec](PROJ-53-gantt-timeline-scale.md) | 2026-05-06 |
...
| PROJ-58 | Interactive Project Graph & Decision Simulation — interaktive 2D-first Graph-Ansicht fuer Projektobjekte, Abhaengigkeiten, Critical Path, Stakeholder, Risiken, Entscheidungen, Budgetwirkungen und KI-reviewbare Entscheidungsbaum-Vorschlaege. | Deployed (α + β-backend + β-UI SVG + γ edge-delete + δ critical-overlay + ε decision-sim + ζ AI-proposal-nodes live; η 3D deferred for CIA-reviewed library) | [Spec](PROJ-58-interactive-project-graph-simulation.md) | 2026-05-07 |
