...
| PROJ-25 | Drag-and-Drop Stack — Backlog↔Sprint + Gantt voll (SVAR React Gantt MIT · polymorphe Deps · Critical-Path manuell · Phasen-Container-Mitziehen) | In Review (Stages 1-5 implemented in prod, /qa pass in progress) | [Spec](PROJ-25-dnd-stack.md) | 2026-04-30 |
