...
| PROJ-53 | Gantt Timeline-Scale (MS-Project-Style) — α: zweireihiger Header + Wochenenden + ISO-KW + Tages-Grid. β: Sticky-Header (SVG-internes `<g translate(0, scrollTop)>`) + Feiertage (`date-holidays`, `tenants.holiday_region`). γ: Memo-Split + Custom-Kalender + Multi-Locale + PNG/PDF-Export. | In Review (α deployed 2026-05-06; β backend deployed 2026-05-06; β frontend implemented 2026-05-11; γ items deferred) | [Spec](PROJ-53-gantt-timeline-scale.md) | 2026-05-06 |
