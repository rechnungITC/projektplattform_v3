...
| PROJ-61 | Jira-like Releases with Story Gantt / Phase Mapping — echte Scrum/SAFe Release-Planung unter `/releases` mit Story-/Task-/Bug-Timeline, Sprint-/Release-Bezug und Abgrenzung zum bestehenden Phase/Work-Package-Gantt. | In Progress (backend α/β + frontend γ) | [Spec](PROJ-61-jira-like-releases-story-gantt.md) | 2026-05-09 |
