...
| PROJ-34 | Stakeholder Communication Tracking (Interaktionshistorie, Sentiment, Kooperationssignale, Reaktionsverhalten, Coaching-Kontext) | In Progress (34-α/β/γ.1/γ.2/δ/ζ live on main; ε open) | [Spec](PROJ-34-stakeholder-communication-tracking.md) | 2026-05-06 |
...
| PROJ-61 | Jira-like Releases with Story Gantt / Phase Mapping — echte Scrum/SAFe Release-Planung unter `/releases` mit Story-/Task-/Bug-Timeline, Sprint-/Release-Bezug und Abgrenzung zum bestehenden Phase/Work-Package-Gantt. | In Progress (backend α/β) | [Spec](PROJ-61-jira-like-releases-story-gantt.md) | 2026-05-09 |
