...
| PROJ-51 | Modern UI/UX & Motion System — Design-System-Audit, Corporate-Farben, Interaction Tokens, shadcn/Radix Refresh, Motion Layer und View-Transition-Pruefung | In Progress (α + β + γ + δ + ε baseline deployed: shadcn Light/Dark restored + Dark-Teal opt-in + brand layer + risk/success/warning tokens + Button/Card microinteractions + Dialog backdrop-blur + framer-motion + view-transition hook + 2 Playwright snapshots; γ.5/γ.6/δ.2/ε.2 polish pending) | [Spec](PROJ-51-modern-ui-ux-motion-system.md) | 2026-05-06 |
