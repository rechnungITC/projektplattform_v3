...
| PROJ-32 | Tenant Custom AI Provider Keys (Multi-Provider Anthropic / OpenAI / Google / Ollama) — 4 Sub-Slices | Deployed 32a + 32c + 32b (Anthropic + OpenAI + Google + Ollama all live); 32d to be specced | [Spec](PROJ-32-tenant-ai-provider-keys.md) | 2026-05-04 |
