...
| PROJ-44 | Context Ingestion Pipeline — Dokumente, E-Mails und Meeting-Notizen als strukturierte Context Sources mit Normalisierung, Privacy-Klassifizierung und Proposal-Queue | In Progress (α + β + γ classifier + δ proposal-stub live; ε UI deferred) | [Spec](PROJ-44-context-ingestion-pipeline.md) | 2026-05-06 |
...
| PROJ-57 | Participant, Stakeholder & Resource Linking Operating Model — macht die Beziehungen zwischen Tenant Member, Project Member, Stakeholder, Resource, Rolle und Tagessatz explizit, inkl. geführter Verknüpfung und Class-3-Masking. | In Progress (α + β aggregator/API + β-UI RelationshipCard live; γ/δ/ε deferred) | [Spec](PROJ-57-participant-resource-linking-operating-model.md) | 2026-05-07 |
| PROJ-58 | Interactive Project Graph & Decision Simulation — interaktive 2D-first Graph-Ansicht fuer Projektobjekte, Abhaengigkeiten, Critical Path, Stakeholder, Risiken, Entscheidungen, Budgetwirkungen und KI-reviewbare Entscheidungsbaum-Vorschlaege. | In Progress (α + β-backend + β-UI SVG-renderer live; γ/δ/ε/ζ/η deferred until CIA-reviewed library) | [Spec](PROJ-58-interactive-project-graph-simulation.md) | 2026-05-07 |
