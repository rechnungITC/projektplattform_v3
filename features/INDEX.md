...
| PROJ-32 | Tenant Custom AI Provider Keys (Multi-Provider Anthropic / OpenAI / Google / Ollama) — 4 Sub-Slices | Deployed 32a + 32c (full slice live + QA Approved + tagged); 32b/d to be specced | [Spec](PROJ-32-tenant-ai-provider-keys.md) | 2026-05-04 |
