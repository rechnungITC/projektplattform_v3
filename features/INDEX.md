...
| PROJ-58 | Interactive Project Graph & Decision Simulation — interaktive 3D-first Graph-Ansicht fuer Projektobjekte, Abhaengigkeiten, Critical Path, Stakeholder, Risiken, Entscheidungen, Budgetwirkungen und KI-reviewbare Entscheidungsbaum-Vorschlaege; 2D-SVG bleibt Fallback. | Architected (α + β-backend + β-UI SVG + γ edge-delete + δ critical-overlay + ε decision-sim + ζ AI-proposal-nodes + η framer-motion polish live; θ 3D-Verbindungsgraph ready for /frontend) | [Spec](PROJ-58-interactive-project-graph-simulation.md) | 2026-05-07 |
