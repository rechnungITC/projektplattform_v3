...
| PROJ-34 | Stakeholder Communication Tracking (Interaktionshistorie, Sentiment, Kooperationssignale, Reaktionsverhalten, Coaching-Kontext) | In Progress (34-α/β/γ.1/δ/ζ live on main; γ.2/ε open) | [Spec](PROJ-34-stakeholder-communication-tracking.md) | 2026-05-06 |
...
| PROJ-63 | Organization CSV Import — papaparse-basierter Importer mit 2 fixen Layouts (OrgChart-Hierarchy + Person-Assignment), Upload → Preview → Commit-Transaktion → optional Rollback, `organization_imports` Tracking-Tabelle, Dedup auf `(tenant_id, code)`, tenant-admin-only. CIA-reviewed; papaparse als neue Dep freigegeben. | In Progress | [Spec](PROJ-63-organization-csv-import.md) | 2026-05-09 |
