...
| PROJ-32 | Tenant Custom AI Provider Keys (Multi-Provider Anthropic / OpenAI / Google / Ollama) — 4 Sub-Slices | Deployed 32a · In Progress 32c (α schema live, β/γ pending); 32b/d to be specced | [Spec](PROJ-32-tenant-ai-provider-keys.md) | 2026-05-04 |
