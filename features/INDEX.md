...
| PROJ-44 | Context Ingestion Pipeline — Dokumente, E-Mails und Meeting-Notizen als strukturierte Context Sources mit Normalisierung, Privacy-Klassifizierung und Proposal-Queue | In Progress (α spec + β-foundation table+API live; γ Auto-Klassifikator + δ AI-Proposal-Queue + ε UI deferred) | [Spec](PROJ-44-context-ingestion-pipeline.md) | 2026-05-06 |
...
| PROJ-55 | Tenant Context, Settings Schema & Audit Hardening — behebt Review-Funde zu Active-Tenant-Auflösung, Module-Settings-Drift und Audit-Tracked-Columns fuer Ressourcen/Allokationen. Stabilisierung vor weiteren Stammdaten-/Resource-/Dashboard-Slices. | Deployed (α cookie-resolver + β settings-schema + γ audit-columns + δ regression-tests; 1253/1253 vitest, AC-3 als pragmatischer Fallback dokumentiert) | [Spec](PROJ-55-tenant-context-settings-audit-hardening.md) | 2026-05-07 |
| PROJ-56 | Project Readiness & Health Command Center — ersetzt den Project-Room-Health-Stub durch echte Readiness-Checks, Health Score, Next-Best-Actions und Report-Integration aus Sicht eines Projektleiters. | Deployed (MVP α + β + γ live; δ Wizard-Handoff + ε Report-Integration deferred) | [Spec](PROJ-56-project-readiness-health-command-center.md) | 2026-05-07 |
| PROJ-57 | Participant, Stakeholder & Resource Linking Operating Model — macht die Beziehungen zwischen Tenant Member, Project Member, Stakeholder, Resource, Rolle und Tagessatz explizit, inkl. geführter Verknüpfung und Class-3-Masking. | In Progress (α docs + β aggregator/API live; β-UI + γ/δ/ε deferred) | [Spec](PROJ-57-participant-resource-linking-operating-model.md) | 2026-05-07 |
| PROJ-58 | Interactive Project Graph & Decision Simulation — interaktive 2D-first Graph-Ansicht fuer Projektobjekte, Abhaengigkeiten, Critical Path, Stakeholder, Risiken, Entscheidungen, Budgetwirkungen und KI-reviewbare Entscheidungsbaum-Vorschlaege. | In Progress (α docs + β-backend aggregator/API live; β-UI + γ/δ/ε/ζ/η deferred) | [Spec](PROJ-58-interactive-project-graph-simulation.md) | 2026-05-07 |
