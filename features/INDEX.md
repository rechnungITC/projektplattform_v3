...
| PROJ-34 | Stakeholder Communication Tracking (Interaktionshistorie, Sentiment, Kooperationssignale, Reaktionsverhalten, Coaching-Kontext) | Architected (CIA-reviewed 2026-05-12 — 8 architecture locks, 7 slices α/β/γ.1/γ.2/δ/ε/ζ ~9.5 PT) | [Spec](PROJ-34-stakeholder-communication-tracking.md) | 2026-05-06 |
...
| PROJ-58 | Interactive Project Graph & Decision Simulation — interaktive 3D-first Graph-Ansicht fuer Projektobjekte, Abhaengigkeiten, Critical Path, Stakeholder, Risiken, Entscheidungen, Budgetwirkungen und KI-reviewbare Entscheidungsbaum-Vorschlaege; 2D-SVG bleibt Fallback. | In Progress (α + β-backend + β-UI SVG + γ edge-delete + δ critical-overlay + ε decision-sim + ζ AI-proposal-nodes + η framer-motion polish live; θ 3D-Frontend implemented, clean QA/deploy pending) | [Spec](PROJ-58-interactive-project-graph-simulation.md) | 2026-05-07 |
