...
## Status: Deployed (α — Katalog-Lesesicht: Phasen-Preset + Workstreams + Deliverables + Buy-Side-Default + Wizard-Picker; 2026-07-27, Tag `v2.26.0-PROJ-96`). Aufgaben-/RACI-Templates + Custom-CRUD/Copy/echte Versionierung/Deep-Editor `deferred → PROJ-Y-96b/96c/96d/96e` (Scope-Ehrlichkeit via PROJ-141-γ1 2026-07-31; **[PROJ-Y-96e](PROJ-Y-96e-aufgaben-templates-ma-template-tasks.md)** — Aufgaben-Templates via Kind-Tabelle `ma_template_tasks` + Copy-Erweiterung in `apply_ma_project_template` + Herkunfts-Stempel auf `work_items` — 2026-08-03 registriert, Spec-Detail 2026-08-04)
## Deployment Scope: alpha

> **Scope-Klassifikation (PROJ-Y-145b, Tranche 3, 2026-08-20):** Der Statusheader nennt die Grenze selbst („Deployed (α — Katalog-Lesesicht)"). **AC2 ⚠ PARTIAL** (Custom-Create/Copy/Deep-Version-Edit → PROJ-Y-96c/96d), DoD-Zeile „Versionierung" `[~]`. PROJ-Y-96b (RACI) und PROJ-Y-96e (Aufgaben) sind inzwischen geliefert, 96c/96d bleiben offen.
